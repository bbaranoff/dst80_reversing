...
def run_search(c1, t1, c2, t2, max_keys):
    # Sélection GPU NVIDIA optimisée
# Initialisation de la plateforme et du contexte
    ...
    # --- CORRECTION ICI : Instanciation unique du kernel ---
    ...
    print(f"--- sdr Search (Dual Challenge | m=0x2F) : {dev.name} ---")
    ...
    for base in range(0, max_keys, chunk_size):
        ...
        # --- UTILISATION DU KERNEL INSTANCIÉ ---
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="sdr dual challenge search (m=0x2F fixed)")
    ...
    # Espace de recherche pour 4 octets variables (255^4)
    parser.add_argument("max_keys", type=int, nargs='?', default=4228250625)
