...
# ---------------------------
# test vectors
print("[bold green]Test vectors TI DST80 Pseudo-officials[/bold green]")
dst80_test_vectors = [
    {
        "keyL": 0x0000000000,
        "keyR": 0x0000000000,
...
print("[bold green]tested alogorithm responses[/bold green]")
print(hex(dst80(0x0000000000, 0x0000000000, 0xC212345678)))
print(hex(dst80(0xAAAAAAAAAA, 0x0000000000, 0xC212345678)))
print(hex(dst80(0x0000000000, 0xAAAAAAAAAA, 0xC212345678)))
print(hex(dst80(0xAAAAAAAAAA, 0xAAAAAAAAAA, 0xC212345678)))

print("[bold red]Testing keys 0xfd4aedd12f, 0xd02e12b502[/bold red]")
print("Test1 Challenge: Challenge = 0x7465736c61")
print("Response",hex(dst80(0xfd4aedd12f, 0xd02e12b502, 0x7465736c61)))
print("Test2 Challenge: Challenge = 0x7465736c62")
print("Response",hex(dst80(0xfd4aedd12f, 0xd02e12b502, 0x7465736c62)))
